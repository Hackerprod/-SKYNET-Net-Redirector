...
internal static partial class Interop
{
    internal static partial class HttpApi
    {
        ...
        [DllImport(Libraries.HttpApi, SetLastError = true)]
        internal static extern unsafe uint HttpSendHttpResponse(SafeHandle requestQueueHandle, ulong requestId, uint flags, HTTP_RESPONSE* pHttpResponse, void* pCachePolicy, uint* pBytesSent, IntPtr pRequestBuffer, uint requestBufferLength, NativeOverlapped* pOverlapped, void* pLogData);
        ...
        [DllImport(Libraries.HttpApi, SetLastError = true)]
        internal static extern unsafe uint HttpSendResponseEntityBody(SafeHandle requestQueueHandle, ulong requestId, uint flags, ushort entityChunkCount, HTTP_DATA_CHUNK* pEntityChunks, uint* pBytesSent, IntPtr pRequestBuffer, uint requestBufferLength, NativeOverlapped* pOverlapped, void* pLogData);
